...
let text = `		"ラジ ： 安藤さん、ちょっといいですか。",
		...
		"ラジ：え？燃えないごみ？",
		"安藤：この 会社ではごみの出し方があります。教えてあげますね。生ごみ、紙などのごみは 燃えるごみです。緑のごみ袋に入れてから捨てます。瓶や缶などは燃えないごみです。オレンジの袋に入れます。粗大ごみなら、電話で申し込",
		"んで,ごみを取りに来てもらいます。",
		"ラジ ：粗大ごみ？",
		"安藤：自転車とか、椅子とか",
		"ラジ ：そうなんですね。",
		"安藤：それから、ごみを 出す曜日も違がいますよ。燃えるごみは 火曜日、木曜日、金曜日の 朝に 出だしてくださ。",
		"燃えないごみは 月曜日と 水曜日の 朝です。",
		"ここの紙に 書いてあります。",
		"ラジ ：わかりました。ありがとうございます。",
		"すみませんが、ごみを 置く場所を 教えていただけませんか。",
		"安藤：ごみ置き場は このビルの 横です"
`;
